package com.force.cinemaline.common.constant;
...
public class Constant {
    ...
    public final static int LOCATION_REQUEST_CODE = 111;
    public final static int RESULT_NULL = 200;
    public final static int RESULT_OK = 201;

    public final static String CITYS = "{\"China\":[\n" +
            "{\"n\":\"直辖市\",\"c\":[\"北京\",\"上海\",\"天津\",\"重庆\"]},\n" +
